    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-grow flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8 mt-10 mb-20">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="{{ route('demo') }}" class="px-8 py-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 font-bold text-lg rounded-xl shadow-sm transition-all duration-300 transform hover:-translate-y-1 flex items-center justify-center gap-2">
